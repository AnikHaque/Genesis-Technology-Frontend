...
const Choose = () => {
  ...
  return (
    <div className="h-screen relative">
      <img src={bg3} className="absolute inset-0 object-cover h-full w-full" />
      <img
        src={bg1}
      ...
      <div className=" z-30 absolute left-0 top-[10%] h-[80%] w-full px-0 md:px-7 lg:px-10">
        <div className=" h-full w-full flex justify-center gap-8 md:gap-20">
          <div className="my-[10px] shadow-[rgba(0,0,0,0.2)_3px_3px_10px_1px,_rgba(0,0,0,0.2)_-3px_-3px_10px_1px] z-30 bg-white flex items-center justify-center h-[90%] w-[100%] max-w-[550px] p-4">
            <div className="h-full w-full flex flex-col p-4 gap-4">
              <p className="text-orange-500 underline text-lg">{title}</p>
              <h2 className="text-[#0C2239] text-[45px] font-bold mb-2">
                {heading}
              </h2>

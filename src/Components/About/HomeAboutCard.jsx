      ...
      <div className="container mx-auto px-[5%] pb-[80px]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 my-10 p-4">
          ...
          <div className="group relative">
            <div className="relative flex flex-cols-3 bg-[#fcf8f5] group-hover:bg-orange-500 p-[30px] border border-gray-100 shadow-sm">
            ...
            {/* Hide on hover */}
            <div
              className="absolute top-14 right-16 text-[#ff8d2c] opacity-20 z-0 animate-ping text-7xl group-hover:hidden"
              style={{
            ...
            <div
              className="absolute top-14 right-16 text-[#ff8d2c] z-0 hidden group-hover:block group-hover:animate-spin text-7xl"
              style={{
                animationDuration: "3s",
                animationTimingFunction: "ease-in-out",
              }}
          ...
          <div className="relative">
            ...
            <div
              className="absolute top-14 right-16 text-[#ff8d2c] z-0 animate-spin text-7xl"
              style={{

...
const HomeAboutMain = () => {
  ...
  return (
    <div className="font-rajdhani px-[5%]">
      <p className="font-semibold text-lg text-[#FF7907] underline pb-3.5">
      ...
      <button className="bg-[#FF7905] text-lg font-roboto text-white px-16	py-5 my-6 hover:bg-[#DC6600] rounded-md">
        About Us
      </button>
    </div>
  );
